<h1>Manutenção de Produto</h1>
<form class="form-horizontal" id="produto_form" method="post" action="produto/edit" novalidate>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
       ...
       <a href="produto/list/<?php echo $this->chavePesq."/".$this->campoPesq ?>" class="btn btn-default">Voltar para pesquisa</a>
    </div>
  </div>
  ...
  <input type="hidden" name="qtde_est" value="<?php echo $this->campos->qtde_est; ?>" />
</form>
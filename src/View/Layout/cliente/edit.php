<h1>Manutenção de Cliente</h1>
<form class="form-horizontal" id="cliente_form" method="post" action="cliente/edit" novalidate>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
       ...
       <a href="cliente/list/<?php echo $this->chavePesq."/".$this->campoPesq ?>" class="btn btn-default">Voltar para pesquisa</a>
    </div>
  </div>
